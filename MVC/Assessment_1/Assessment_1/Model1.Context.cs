...
namespace Assessment_1
{
    ...
    public partial class northwindEntities : DbContext
    {
        ...
        public virtual int adddata(Nullable<int> id, string v, ObjectParameter res)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("adddata", idParameter, vParameter, res);
        }
        ...
        public virtual ObjectResult<getdata_Result> getdata(string data)
        {
            var dataParameter = data != null ?
                new ObjectParameter("data", data) :
                new ObjectParameter("data", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getdata_Result>("getdata", dataParameter);
        }
